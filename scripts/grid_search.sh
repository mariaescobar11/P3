...
echo "Iniciant la cerca de paràmetres (Grid Search)..."
echo "Això pot trigar un parell de minuts. Si us plau, espera."
echo "=========================================================="

# Llistes de valors a provar al voltant dels teus (a OJO)
Z_VALS="0.05 0.10 0.15"
P_VALS="-50 -52 -54"
R1_VALS="0.25 0.30 0.35"
RM_VALS="0.25 0.30 0.35"
